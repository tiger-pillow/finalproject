...
I realize that 1000 trees are not sufficient to resolve the phylogeny, as shown below. Therefore I did ancestral state reconstruction on a randomly chosen tree. For the final version, I plan to run on 10,000 trees. I will settle with a random tree for now because 10,000 trees 
takes significantly longer time to process.
