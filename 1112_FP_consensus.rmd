...
**Unfortunately the HTML is not searchable**  
...
```{r, fig.height = 200, include = FALSE}
...
```{r,  fig.height = 300, fig.width = 40, echo = FALSE}
...
globaltree = ggtree(tree_global ) + 
  ...
  xlim(0, 1.2) + 
  geom_text2(aes(label = node_values), nudge_x = 0.02, size = 10) +
