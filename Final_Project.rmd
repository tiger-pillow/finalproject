---
title: 'E&EB 354 Final Project -- Possibility of Rodent Litter Size as a Predictor
  for Menstruation '
output:
...
node_values_ML = c(charstate$Average, round(litter_ancestral_ML$ace, digits= 2)) # datastructure for plotting the tips
...
```
Metadata about ML reconstruction: 

Residual log-likelihood: `r litter_ancestral_ML$resloglik` 

Sigma2: `r litter_ancestral_ML$sigma2`
