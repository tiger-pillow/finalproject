...
## ML 
```{r, fig.height = 120, fig.width = 50, echo = FALSE}
...
Sigma2: `r litter_ancestral_REML$sigma2`
...
A_methods %>%
  ...
  geom_point() +
  geom_abline(slope = 1, intercept = 0, color = "blue") + coord_equal(ratio = 1)
